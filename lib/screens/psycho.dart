...
class PsychoProfile extends StatefulWidget {
  final DocumentSnapshot dsa;
  final DataFromSharedPref us;
  PsychoProfile({this.dsa, this.us});
  @override
  _PsychoProfileState createState() => _PsychoProfileState();
}

class _PsychoProfileState extends State<PsychoProfile> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    List<dynamic> price = widget.dsa.data()["price"].toList();
    return Scaffold(
                          ...
                          () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              ...
                              builder: (context) => PaymentRazorpay(
                                ds: widget.dsa,
                                userData: widget.us,
                                // amount: widget.dsa["fees"]["30mins"],
                                paymentfor: widget.dsa["name"],
                              ),
                            ),
                          ),
                        ),
